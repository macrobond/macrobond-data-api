...
class Database:
    ...
    def CreateSeriesObject(
        self, name: str, description: str, region: str, category: str,
        frequency: int, dayMask: int, startDateOrDates: object, values: object, metadata: Metadata
    ) -> Series:
        '''
    ...
    def CreateSeriesObjectWithForecastFlags(
        self, name: str, description: str, region: str, category: str, frequency: int,
        dayMask: int, startDateOrDates: object, values: object, forecastFlags: object,
        metadata: Metadata
    ) -> Series:
        '''
