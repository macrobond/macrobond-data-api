...
if TYPE_CHECKING:  # pragma: no cover
    ...
    from .com_typs import Connection, Database, \
...
class _ListValuesReturn(MetaDirectoryMethods.ListValuesReturn):
    ...
    def list_of_objects(self) -> List[MetadataValueInformation]:
        ...
        def to_object(info: 'ComMetadataValueInformation') -> 'MetadataValueInformation':
            return MetadataValueInformation(self.__name, info.Value, info.Description, info.Comment)
